...
//					cached ? "(cached)" : "", audio_frame_count++,
//					frame->nb_samples,
...
int demux(const char *src_file, const char *video_file, const char *audio_file) {
	...
	video_dst_filename = video_file;
	audio_dst_filename = audio_file;
	...
	if (audio_stream) {
		...
		printf("Play the output audio file with the command:\n"
				...
				audio_dec_ctx->sample_rate, audio_dst_filename);
	}
